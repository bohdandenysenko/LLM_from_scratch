import torch
from src.arc.model import GPTConfig, GPTModel_v2 # customized implementation with RoPE, weight tying, combined QKV projections, KV cache
...
if __name__ == "__main__":
    ...
    model = GPTModel_v2(config=GPT_CONFIG_124M)
